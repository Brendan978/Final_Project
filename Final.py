...
class BookstoreApp:
    def __init__(self, root):
        ...
        try:
            background_image1 = Image.open(r"C:\Users\bradf\AppData\Local\Programs\Python\Python312\SDEV 140\Final_Project\Library_Books.png")
            background_image1 = ImageTk.PhotoImage(background_image1)
            self.background_label = tk.Label(root, image=background_image1)
    ...
    def populate_books(self):
        books_data = [
            ...
            ("Book 3", "Author 3", "Mystery", 25.0, "Intriguing mystery novel."),
            ("Book 4", "Author 4", "Science Fiction", 18.0, "Adventure in space."),
            ("Book 5", "Author 5", "Romance", 22.0, "A love story that will tug at your heart."),
            ("Book 6", "Author 6", "History", 30.0, "Exploring historical events."),
        ]
    ...
    def add_to_cart(self):
        ...
        if selected_book_index:
            book_id = selected_book_index[0] + 1
            with self.conn:
                cursor = self.conn.cursor()
    ...
    def checkout(self):
        ...
        try:
            checkout_background = Image.open(r"C:\Users\bradf\AppData\Local\Programs\Python\Python312\SDEV 140\Final_Project\Library_Scene.png")
            checkout_background = ImageTk.PhotoImage(checkout_background)
            self.background_label.configure(image=checkout_background)
            self.background_label.image = checkout_background
        except Exception as e:
            print(f"Error loading checkout background image: {e}")
        ...
        try:
            original_background = Image.open(r"C:\Users\bradf\AppData\Local\Programs\Python\Python312\SDEV 140\Final_Project\Library_Books.png.jpg")
            original_background = ImageTk.PhotoImage(original_background)
            self.background_label.configure(image=original_background)
            self.background_label.image = original_background
        except Exception as e:
            print(f"Error loading original background image: {e}")
